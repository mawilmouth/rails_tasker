...
Gem::Specification.new do |gem|
  gem.name          = 'rails-tasker'
  gem.version       = RailsTasker::VERSION
  gem.authors       = ['Michael Wilmouth']
  gem.email         = ['wilmouthworks@gmail.com']

  gem.summary       = 'Automate your Rails after-deployment tasks with rails-tasker'
  gem.description   = gem.summary
  gem.homepage      = 'https://github.com/mawilmouth/rails-tasker'
  gem.license       = 'MIT'
  gem.required_ruby_version = Gem::Requirement.new('>= 2.3.0')

  gem.metadata['homepage_uri'] = gem.homepage
  gem.metadata['source_code_uri'] = 'https://github.com/mawilmouth/rails-tasker'
